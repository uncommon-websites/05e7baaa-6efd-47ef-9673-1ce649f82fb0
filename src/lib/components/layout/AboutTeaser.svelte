...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		...
		role: "CEO & Co-Founder",
		image: "/generated/image-a-professional-founder-standing-confiden.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"I spent years training AI agents that worked beautifully in simulation but failed in the real world. That gap between synthetic environments and actual work kept me up at night. We built Fleet because reliable agents need realistic training grounds, and the industry wasn't going to solve this on its own."`}
			/>
